...
var reDirective = /^!([a-zA-Z][a-zA-Z0-9_-]+)[ \t]*(.*)$/;
...
var blockStarts = [
    ...
    function(parser) {
        ...
        if (
            ...
            parser.closeUnmatchedBlocks();
            var container = parser.addChild("directive", parser.nextNonspace);
            container.directive = match[1].trim();
            container.args = match[2].trim();
